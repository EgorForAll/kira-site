<script>
import ListCard from "../../blocks/admin/ListCard.vue";
...
<template>
    <section class="posts">
        ...
        <div class="container post__container-admin  pt-2 pb-2 pt-md-3 pb-md-3 pt-lg-5 pb-lg-5">
